...
export default function AdminLogin({ onSubmit, error, loading }) {
  ...
  return (
    ...
    >
      <div className="mb-1 text-center text-sm font-semibold text-black">Admin sign-in</div>
      <p className="mb-4 text-center text-[11px] text-slate-600">Direct access for Admin, CEO and COO.</p>
